...
public class GladLibMap {
    ...
    private String processWord(String w){
     ...
     int first = w.indexOf("<");
     int last = w.indexOf(">",first);//start looking for index of > from first
     ...
     //check if the word you replace with the <label> used before or not
     while(true){
   ...
   private int totalWordsConsidered(){
    ...
    for(String s: fr.words()){
     ...
     if(s != processWord(s)){
        ...
        if(uniqueLabels.contains(a) == false){
          uniqueLabels.add(a);
        }
      }
    }
